    ...
    {/*<!--main-left-->*/}
      ...
      <div className="left-content">
        ...
        <div className="user-info-box">
          <img src="https://picsum.photos/200/200" alt="" className="background-image" />
          <div className="userpfpdiv"><img src="https://picsum.photos/100/100" alt="" className="user-pfp" /></div>
